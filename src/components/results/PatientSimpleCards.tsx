  ...
  return (
    <section className="space-y-4">
      ...
      <Card className="overflow-hidden border-blue-100 bg-gradient-to-br from-white/95 to-blue-50/80 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md">
        ...
        <CardContent className="space-y-3 pt-1 text-[15px] leading-relaxed text-slate-700">
          <p className="font-medium text-slate-900">{summaryText}</p>
          <p className="text-sm text-slate-500 bg-white/60 p-3 rounded-lg border border-slate-100">{followupSummary}</p>
        </CardContent>
      </Card>

      {/* Grid: Confidence & Follow Up */}
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="border-slate-200/60 bg-white/80 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
          ...
          <CardContent className="pt-3 text-sm text-slate-600 leading-relaxed">
            <p>{confidenceText}</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200/60 bg-white/80 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
          ...
          <CardContent className="pt-3 space-y-1 text-sm text-slate-600">
            <p className="font-semibold text-slate-900 text-[15px]">{followupLabel}</p>
            <p className="text-slate-500">{timeframeFromPriority(followupPriority)}</p>
          </CardContent>
        </Card>
      </div>

      {/* Specific Content Cards */}
      <Card className="border-indigo-100 bg-white shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md">
        ...
        <CardContent className="text-sm text-slate-700 pt-2 pb-4">
          <div className="space-y-3">
            {observations.map((item) => (
              <div key={item} className="flex items-start gap-3 bg-slate-50/60 p-3 rounded-lg border border-slate-100 transition-colors hover:bg-slate-50">
                <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-indigo-100 text-indigo-700">
      ...
      <Card className="border-emerald-100 bg-white shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md">
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-base font-bold text-slate-800">
      ...
      <Card className="border-teal-100 bg-white shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md">
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-base font-bold text-slate-800">
        ...
        <CardContent className="text-sm text-slate-700 pt-2 pb-4">
          <div className="space-y-3">
            {clinicianQuestions.map((question) => (
              <div key={question} className="flex items-start gap-3 bg-slate-50/60 p-3 rounded-lg border border-slate-100 transition-colors hover:bg-slate-50">
