...
function loadAssessments(): AssessmentRow[] {
...
export default function AdminPortalPage() {
  const rows = useMemo(() => loadAssessments(), []);
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden">
      <div className="pointer-events-none absolute right-[-6rem] top-[-4rem] h-56 w-56 rounded-full bg-muted/20 blur-3xl" />
                      ...
                      return (
                        <tr key={row.id} className="border-b border-border/50 bg-card last:border-b-0 hover:bg-surface-container-low/40 transition-colors">
                          ...
                          <td className="px-4 py-3 align-top">
                            ...
                            <p className="mt-0.5 max-w-[180px] text-[11px] text-muted-foreground line-clamp-2">
                              {row.confidenceNotes}
                            </p>
                          </td>
                          <td className="px-4 py-3 align-top">
